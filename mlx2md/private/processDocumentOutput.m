...
str2md = regexprep(str2md,"\\matlabtitle{([^{}]+)}","# $1"+newline);
str2md = regexprep(str2md,"\\matlabheading{([^{}]+)}","## $1"+newline);
str2md = regexprep(str2md,"\\matlabheadingtwo{([^{}]+)}","### $1"+newline);
str2md = regexprep(str2md,"\\matlabheadingthree{([^{}]+)}","#### $1"+newline);
...
str2md = erase(str2md,"\begin{par}"+newline);
str2md = erase(str2md,"\end{par}");
str2md = erase(str2md,"\begin{flushleft}"+newline);
str2md = erase(str2md,newline+"\end{flushleft}");
